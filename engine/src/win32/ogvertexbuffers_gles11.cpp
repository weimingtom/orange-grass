...
COGVertexBuffers_GLES11::COGVertexBuffers_GLES11 () : m_pMesh(NULL),
										m_VBO(0),
										m_IBO(0),
										m_NumVertices(0)
{
...
COGVertexBuffers_GLES11::~COGVertexBuffers_GLES11 ()
{
}


// initialize VBO and IBO.
COGVertexBuffers_GLES11::COGVertexBuffers_GLES11 (const SPODMesh* _pMesh) :	m_pMesh(_pMesh),
																m_VBO(0),
																m_IBO(0),
																m_NumVertices(0)
{
...
// apply buffers.
void COGVertexBuffers_GLES11::Apply () const
{
#ifdef USE_VBO
...
void COGVertexBuffers_GLES11::Render () const
{
