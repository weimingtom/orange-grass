 ...
 *
 */
#ifndef OGSHADOWEDTRANSPSCENESHADER_H_
#define OGSHADOWEDTRANSPSCENESHADER_H_

#include "IOGShader.h"


class COGShadowedTranspSceneShader : public IOGShader
{
public:
    COGShadowedTranspSceneShader ();
    virtual ~COGShadowedTranspSceneShader ();
