 ...
 */
#ifndef OGSHADOWTRANSPARENTMODELSHADER_H_
#define OGSHADOWTRANSPARENTMODELSHADER_H_

#include "IOGShader.h"


class COGShadowTransparentModelShader : public IOGShader
{
public:
    COGShadowTransparentModelShader ();
    virtual ~COGShadowTransparentModelShader ();
